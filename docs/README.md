...
最終更新: 2026-04-29
バージョン: v3.0 (HTMLプロトタイプ完成 + LocalWP/SWELL環境構築完了)
...
### v3.0 (2026-04-29): HTMLプロトタイプ完成 + ローカル開発環境構築
- HTMLプロトタイプ v1→v4 完成（実写真5名+本物ロゴ埋め込み）
- デザイン方針v4確定: 暖色クリームベース×マルチカラー暖色パレット
  - 純白→暖色クリーム `#fdfaf4`、コーラル/ピーチ/ゴールド追加
  - グラスモーフィズム採用、非対称border-radius、Bodoni Modaセリフ追加
  - 写真主役レイアウト（エディトリアル×マガジン風）
- ブランドガード確立: 「フレッシュ」「Fresh」文言使用厳禁
- ロゴPDFから画像抽出（PyMuPDF 300dpi→PIL自動トリミング）
- LocalWP導入 → WordPress 6.9.4 稼働（g.local）
- SWELL 2.16.0 親テーマ+子テーマ インストール・有効化
- `docs/project-memo-v4.md` 追加
- `06-design-direction.md` カラーパレットv4反映
